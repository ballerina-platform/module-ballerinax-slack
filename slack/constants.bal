...
const string LOOKUP_BY_EMAIL_PATH = "/users.lookupByEmail?email=";
...
const string GET_CONVERSATION_HISTORY_PATH = "/conversations.history?channel=";
const string GET_CONVERSATION_MEMBERS_PATH = "/conversations.members?channel=";
